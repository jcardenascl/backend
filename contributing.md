# Contributing to expense-tracker-backend

First and foremost, thank you! We appreciate that you want to contribute to expense-tracker-backend, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for expense-tracker-backend**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for expense-tracker-backend:

- star the [project](https://github.com/expensetrackerofficial/backend)
- tweet your support for expense-tracker-backend
...
- **version**: (required) please note the version of expense-tracker-backend are you using
- **error messages**: (required) please paste any error messages into the issue, or a [gist](https://gist.github.com/)
- **extensions, plugins, helpers, etc** (if applicable): please list any extensions you're using

### Closing issues

The original poster or the maintainers of expense-tracker-backend may close an issue at any time. Typically, but not exclusively, issues are closed when:
...
[so]: http://stackoverflow.com/questions/tagged/expense-tracker-backend
